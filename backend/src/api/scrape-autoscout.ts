...
scrapeAutoscoutRouter.get('/run', async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    const premiumSearches = [
      ...
      { path: 'porsche/carrera-gt', kw: 0, pages: 1 },
      ...
      { path: 'mercedes-benz/c-klasse', kw: 250, pages: 2 },
      { path: 'mercedes-benz/e-klasse', kw: 250, pages: 2 },
      { path: 'mercedes-benz/glc-klasse', kw: 250, pages: 2 },
      ...
      { path: 'audi/rs4', kw: 200, pages: 2 },
      { path: 'jaguar/f-type', kw: 150, pages: 3 },
      { path: 'nissan/gt-r', kw: 0, pages: 3 },
      { path: 'alfa-romeo/giulia', kw: 300, pages: 3 },
      { path: 'alfa-romeo/stelvio', kw: 300, pages: 3 },
      ...
      { path: 'tesla/model-s', kw: 200, pages: 3 },
      { path: 'tesla/model-3', kw: 200, pages: 3 },
      { path: 'tesla/model-x', kw: 200, pages: 2 },
      // Land Rover / Range Rover
      { path: 'land-rover/range-rover-sport', kw: 200, pages: 3 },
      { path: 'land-rover/range-rover', kw: 200, pages: 3 },
      { path: 'land-rover/defender', kw: 200, pages: 2 },
      // Hot Hatches
